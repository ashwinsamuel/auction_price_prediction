...
PATH_TO_READ_SAVE_MODELS = "/Users/ashwinsamuel/Documents/Kaggle/closing_auction_prediction/models/n1000_False_with_mul_clean"
...
if __name__=='__main__':
    ...
    for width in range(300,280,-20):
        ...
        model.booster_.save_model(f'model_w{width}_{USE_LAST_W_SECONDS}_mul{WINDOW_MULITPLIER}.txt')
